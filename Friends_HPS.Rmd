...
library(htm2txt)  # htm2txt_2.1.1 
library(stringr)  # stringr_1.4.0
library(ngramr)   # ngramr_1.7.2
library(extrafont)# extrafont_0.17
library(forecast) # forecast_8.13
library(ggpubr)   # ggpubr_0.2.5
library(patchwork)# patchwork_1.0.0
library(usmap)    # usmap_0.5.1
library(wordcloud)# wordcloud_2.6
library(RWeka)    # RWeka_0.4-43
library(tm)       # tm_0.7-8
#options(scipen=4)
```
